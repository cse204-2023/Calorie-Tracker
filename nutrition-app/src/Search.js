            ...
            {nutrients && (
                <div id="food-results">
                    ...
                    <ul>
                        ...
                        <li>Fat: {nutrients.fat ? nutrients.fat + " g" : "-"}</li>
                        <li>Carbohydrates: {nutrients.carbohydrates ? nutrients.carbohydrates + "g" : "-"}</li>
                        <li>Fiber: {nutrients.fiber ? nutrients.fiber + " g" : "-"}</li>
                        <li>Sugar: {nutrients.sugar ? nutrients.sugar + " g" : "-"}</li>
